...
public class AddFolderController implements ControllerData<String> {
    @FXML
    ...
    public void initData(String data) {
        path = data;
        path = path.replaceAll("C:\\\\fileUploaderSpring", "");
    ...
    public void buttonAddFolder(ActionEvent actionEvent) {
        if (!textFieldName.getText().isEmpty()) {
            try {
                userDirectoryRepository.add(path, this.textFieldName.getText());
